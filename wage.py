...
path = "/home/ilya/Documents/openfoam/tutorials/compressible/rhoCentralFoam/Phystech_wage/wedge15Ma5"

# Define list of initial velocities
velocities = np.linspace(3.0, 7.0, 100)

# Loop over each velocity and create a copy of the case files
for vel in tqdm(velocities):
    # Create copy of the case directory
    new_path = f"/home/ilya/Documents/openfoam/tutorials/compressible/rhoCentralFoam/Phystech_wage/high_dim/vel{vel}"
